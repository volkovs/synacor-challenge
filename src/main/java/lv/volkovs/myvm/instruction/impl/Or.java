 ...
 *         Date: 25.06.2017
 */
public class Or implements InstructionExecution {

    private int destination;
    private Operand value1;
    private Operand value2;

    public Or(Operand destination, Operand value1, Operand value2) {
    ...
    public int execute(InstructionExecutionContext context) {
        ...
        Value15 result = value1.toValue(memory).or(value2.toValue(memory));
