 ...
 *         Date: 25.06.2017
 */
public class Mod implements InstructionExecution {

    private int destination;
    private Operand value1;
    private Operand value2;

    public Mod(Operand destination, Operand value1, Operand value2) {
    ...
    public int execute(InstructionExecutionContext context) {
        ...
        Value15 result = value1.toValue(memory).mod(value2.toValue(memory));
